...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--load_name_g", type=str, default="", help="load model name"
    )  # ./models/deepfillv2_WGAN_epoch2_batchsize4.pth
    parser.add_argument(
        "--load_name_d", type=str, default="", help="load model name"
    )  # ./models/discriminator_WGAN_epoch2_batchsize4.pth
    # Training parameters
    ...
    parser.add_argument(
        "--lambda_perceptual", type=float, default=100, help="the parameter of FML1Loss (perceptual loss)"
    )
    parser.add_argument(
